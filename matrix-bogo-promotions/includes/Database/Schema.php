 ...
 * Class Schema
 *
 * Defines and installs all custom DB tables using dbDelta().
 */
final class Schema {
	...
	private static function get_schema( string $charset_collate ): array {
		...
		return [
			...
			// ----------------------------------------------------------
			// Rules – top-level promotion definition
			// ----------------------------------------------------------
			...
			// ----------------------------------------------------------
			// Conditions – flexible condition groups per rule
			// ----------------------------------------------------------
			...
			// ----------------------------------------------------------
			// Rewards – what the customer receives
			// ----------------------------------------------------------
			...
			// ----------------------------------------------------------
			// Redemptions – one row per order that used a promotion
			// ----------------------------------------------------------
			...
			// ----------------------------------------------------------
			// Analytics – aggregated daily stats per rule
			// ----------------------------------------------------------
			...
			// ----------------------------------------------------------
			// Logs – audit trail for every promotion event
			// ----------------------------------------------------------
	...
	/**
	 * Drops all custom tables (used by uninstall.php).
	 */
